...
import org.flowable.ui.common.idm.cache.UserCache;
import org.flowable.ui.common.idm.cache.UserCache.CachedUser;
...
public class UserDetailsServiceImpl implements UserDetailsService, CustomUserDetailService {
    ...
    public UserDetails loadUserByUsername(final String login) {
        ...
        String actualLogin = login.toLowerCase();
        User userFromDatabase = identityService.createUserQuery().userIdIgnoreCase(actualLogin).singleResult();
