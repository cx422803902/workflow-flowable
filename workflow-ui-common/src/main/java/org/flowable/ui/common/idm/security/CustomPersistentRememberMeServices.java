...
import org.flowable.ui.common.idm.service.PersistentTokenService;
import org.flowable.ui.common.security.CookieConstants;
import org.flowable.ui.common.security.FlowableAppUser;
import org.flowable.ui.common.util.Base64Util;
...
public class CustomPersistentRememberMeServices extends AbstractRememberMeServices {
    ...
    protected void onLoginSuccess(HttpServletRequest request, HttpServletResponse response, Authentication successfulAuthentication) {
        ...
        Token token = persistentTokenService.createToken(appUser.getUserObject(), request.getRemoteAddr(), request.getHeader("User-Agent"));
    ...
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (System.currentTimeMillis() - token.getTokenDate().getTime() > tokenRefreshDurationInMilliseconds) {
    ...
    private Token getPersistentToken(String[] cookieTokens) {
        ...
        if (System.currentTimeMillis() - token.getTokenDate().getTime() > tokenMaxAgeInMilliseconds) {
    ...
    protected void setCookie(String[] tokens, int maxAge, HttpServletRequest request, HttpServletResponse response) {
        String cookieValue = Base64Util.encode(tokens);
